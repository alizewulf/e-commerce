...
function DropdownUserIcon({className, color}:PropsSVG) {
    return (
        <svg width="32" height="32" viewBox="0 0 32 32" className={className} fill={color} xmlns="http://www.w3.org/2000/svg">
