import type { Props } from "./navprops"

function LoupeSVG({className, color}:Props) {
    return (
        <svg className={className} width="18" height="18" viewBox="0 0 18 18" fill={color} xmlns="http://www.w3.org/2000/svg">
