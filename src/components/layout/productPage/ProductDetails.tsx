...
function ProductDetails({ product }: ProductDetailsProps) {
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="space-y-6 rounded-[28px] border border-black/10 bg-white p-8 shadow-sm">
        <div className="space-y-4">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-wrap items-center gap-3 text-sm text-black/60">
              ...
              <span className={availabilityClass}>{inStock ? "In Stock" : "Out of Stock"}</span>
        ...
        <div className="grid gap-4 sm:grid-cols-[1fr_auto]">
          <div className="flex flex-wrap items-center gap-4">
            ...
            />
            <PrimaryButton className="h-12 px-8">Buy Now</PrimaryButton>
            <button
              type="button"
